    ...
    public partial class Update : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_UserTenant_MustHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                    { "DynamicFilter_UserTenant_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbpUsers", t => t.CreatorUserId)
                .ForeignKey("dbo.AbpUsers", t => t.DeleterUserId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AbpUsersTenants", "LastModifierUserId", "dbo.AbpUsers");
            DropForeignKey("dbo.AbpUsersTenants", "DeleterUserId", "dbo.AbpUsers");
            DropForeignKey("dbo.AbpUsersTenants", "CreatorUserId", "dbo.AbpUsers");
            ...
            DropIndex("dbo.AbpUsersTenants", new[] { "CreatorUserId" });
            DropIndex("dbo.AbpUsersTenants", new[] { "LastModifierUserId" });
            DropIndex("dbo.AbpUsersTenants", new[] { "DeleterUserId" });
            DropIndex("dbo.AbpUsersTenants", new[] { "TenantId" });
            DropIndex("dbo.AbpUsersTenants", new[] { "UserId" });
