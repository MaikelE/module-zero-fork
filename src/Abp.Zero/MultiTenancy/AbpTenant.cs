...
namespace Abp.MultiTenancy
{
    ...
    /// </summary>
    [Table("AbpTenants")]
    public class AbpTenant<TTenant, TUser, TUserTenant> : FullAuditedEntity<int, TUser>, IPassivable
        ...
        where TUserTenant : AbpUserTenant<TTenant, TUser, TUserTenant>
    {
        ...
        /// <summary>
        /// Defined UserTenant for this tenant.
        /// </summary>
        [ForeignKey("TenantId")]
        public virtual ICollection<TUserTenant> UserTenants { get; set; }
